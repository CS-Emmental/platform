data_challenge_category_legit_args = [
    (
        {"_id": "a", "title": "a", "icon": "a","description":"a","created_at": 0,"updated_at": 0},
        {"_id": "a", "title": "a", "icon": "a","description":"a","created_at": 0,"updated_at": 0},
    ),
    (
        {
...
data_challenge_category_error_time = [
    ({"_id": None, "title": "title", "icon": "icon" ,"description": "description","created_at": 10,"updated_at": 5}),
    ({"_id": None, "title": "title", "icon": "icon" ,"description": "description","created_at": None,"updated_at": 10})
]
